        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="__success">
                    ...
                    <p>• Trụ sở chính: 102A,Nhà vườn,KĐT Việt Hưng,Long Biên,Hà Nội</p>
                    <p class="mb-0">Cám ơn Quý khách đã sử dụng Sản phẩm của Công ty chúng Tôi!</p>
                </div>
